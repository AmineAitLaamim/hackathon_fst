...
class TourSerializer(serializers.ModelSerializer):
    ...
    share_id = serializers.UUIDField(source="share.share_id", read_only=True, allow_null=True)
...
class TourShareSerializer(serializers.ModelSerializer):
    class Meta:
        model = TourShare
        fields = ["share_id", "is_active", "settings", "created_at", "updated_at"]
        read_only_fields = ["share_id", "created_at", "updated_at"]
