...
| PATCH | `/api/users/:id/interests` | Partial update — do NOT wipe existing interests |
| PATCH | `/api/users/:id/health` | Partial update — do NOT wipe existing conditions |
...
### `/explore` — Done
- [x] Grid of public tours — filters: sort by rating / recent
